...
//		filterChainDefinitionMap.put("/add", "perms[addOperation]");
	...
	public SimpleCookie remeberMeCookie(){
		...
		//记住我cookie生效时间3天 ,3600 单位秒  [1小时] 86400等于1天;10天
		scookie.setMaxAge(86400*3);
		return scookie;
	}
	 ...
	 * </br>所以如果WebSessionManager有配置cacheManager，需同步改为和sessionDAO里的ehCacheManager。
	 * @创建人：wyait
	...
	public SimpleCookie sessionIdCookie() {
		...
		//3天
		simpleCookie.setMaxAge(86400*3);
		return simpleCookie;
	}
	/**
	 * 
